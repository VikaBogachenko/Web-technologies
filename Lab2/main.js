...
function triangle(data1, type1, data2, type2) {
    ...
    } else if (tria["angle"] && tria["hypotenuse"] && tria["angle"] < 90 && tria["angle"] > 0 && tria["hypotenuse"] > 0) {
    ...
    } else if (tria["leg"] && tria["opposite angle"] && tria["leg"] > 0 && tria["opposite angle"] > 0 && tria["opposite angle"] < 90) {
    ...
    } else if (tria["leg"] && tria["adjacent angle"] && tria["leg"] > 0 && tria["adjacent angle"] > 0 && tria["adjacent angle"] < 90) {
