...
function randomCategory() {
  var short_names = ["Cat_1", "Cat_2", "Cat_3", "Cat_4"];
  var randomIndex = Math.floor(Math.random() * short_names.length);
  var ran_Category = short_names[randomIndex];

  loadCatalogs(ran_Category, "data/catalog/Cat_3.json");
}